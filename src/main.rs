...
mod inst {
    ...
    impl Inst {
        ...
        #[inline(always)]
        pub const fn to_data(self) -> Data {
            Data(self.0)
        }

        #[inline(always)]
        pub const fn to_math(self) -> Math {
            Math(self.0)
        }

        #[inline(always)]
        pub const fn to_jump(self) -> Jump {
            Jump(self.0)
        }
    }
